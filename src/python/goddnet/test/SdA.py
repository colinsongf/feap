...
from goddnet.test import dA

from goddnet.test.logistic_sgd import LogisticRegression, load_cifar10_data
from goddnet.test.mlp import HiddenLayer
...
class SdA(object):
    ...
    def __init__(self, numpy_rng, theano_rng=None, n_ins=784,
                 ...
                 corruption_levels=[0.1, 0.1]):#, L1_reg=0.00, L2_reg=0.000):
        ...
        #self.logLayer = MLP(rng=numpy_rng, input=self.sigmoid_layers[-1].output, n_in=hidden_layers_sizes[-1],
        ...
        self.finetune_cost = self.logLayer.negative_log_likelihood(self.y)#+ L1_reg * self.logLayer.L1\
                             #+ L2_reg * self.logLayer.L2_sqr
...
def test_SdA(finetune_lr=0.1, pretraining_epochs=15,
             ...
             dataset='../../../data/cifar-10-batches-py',batch_size=1):
    ...
    sda = SdA(numpy_rng=numpy_rng, n_ins=3072,
